...
function! s:MapGitOps(is_ftplugin) abort
  ...
  exe s:Map('n', 'cv<CR>', ':tab Git commit -v \| TSToggle highlight<CR>', '', ft)
  ...
  exe s:Map('n', 'cva', ':<C-U>tab Git commit -v --amend \| TSToggle highlight<CR>', '<silent>', ft)
  exe s:Map('n', 'cvc', ':<C-U>tab Git commit -v \| TSToggle highlight<CR>', '<silent>', ft)
